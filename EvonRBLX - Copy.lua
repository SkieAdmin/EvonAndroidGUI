...
if found then
    print("[ Evon A+ ] Detecting Beta Users (Experimental Mode is ON)")
else
    print("Launching Old Evon GUI")
end

if found then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Panda-Repositories/PandaKS_Libraries/main/EvonAPI/EvonLauncher.lua"))()
else
	-- Launch Regular (Evon)
--// Instances
